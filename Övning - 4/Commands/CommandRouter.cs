...
public class CommandRouter
{
    ...
    internal void ListSpecificGarage(string? v)
    {
        garageManager.ListSpecificGarage(v);
    }
    internal void Demo() { garageManager.Demo(); }
    internal void ListAllGarages() {  garageManager.ListAllGarages();  }
    internal void CreateGarage(string? garageType, int? garageSize, string? garageName)
    {
